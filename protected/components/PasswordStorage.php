...
class PasswordStorage {
    ...
    public static function create_hash($password) {
        ...
        $PBKDF2_Output = self::pbkdf2(
                        self::PBKDF2_HASH_ALGORITHM, $password, $salt_raw, self::PBKDF2_ITERATIONS, self::PBKDF2_OUTPUT_BYTES, true
        );
    ...
    public static function verify_password($password, $hash) {
        ...
        return self::slow_equals(
                        $pbkdf2, self::pbkdf2(
                                $params[self::HASH_ALGORITHM_INDEX], $password, $salt_raw, $iterations, self::ourStrlen($pbkdf2), true
                        )
        );
    }
