...
class ReportNameSignatureController extends AdministratorController {
    ...
    public function actionPrint() {
        ...
        switch (Yii::app()->request->getQuery('mode')) {
            ...
            case 'xls':
                ...
                $sheet->setCellValueByColumnAndRow(0, $row, 'ใบเซ็นต์ชื่อผู้เข้ารับการทดสอบวัดระดับความรู้ภาษาอังกฤษ');
                ...
                $sheet->setCellValueByColumnAndRow(6, $row, 'ลายมือชื่อ');
