...
return array(
    ...
    'items' => array(
        ...
        array(
            ...
            'visible' => Yii::app()->user->checkPermission(array(
                'admin.configuration',
                'admin.configurationSms',
                'admin.configurationMail',
                'admin.backup',
            )),
        ),
        array(
        ...
        array(
            ...
            'visible' => Yii::app()->user->checkPermission('admin.configurationSms'),
        ), array(
            'label' => $this->module->getMenuIcon('icon/master') . '10. ตั้งค่าการแจ้งข้อความผ่าน E-Mail',
            'url' => array('configuration/mail'),
            'active' => CHtml::value($this, 'action.id') === 'mail' && in_array($this->id, array(
                'configurationMail',
            )),
            'visible' => Yii::app()->user->checkPermission('admin.configurationMail'),
        ),
        array(
        ...
        array(
            ...
            'visible' => Yii::app()->user->checkPermission('admin.logSms'),
        ),
        array(
            'label' => $this->module->getMenuIcon('icon/log') . '15. ข้อมูลการส่งจดหมาย',
            'url' => array('logMail/index'),
            'active' => in_array($this->id, array(
                'logMail',
            )),
            'visible' => Yii::app()->user->checkPermission('admin.logMail'),
        ),
    ),
    'active' => in_array($this->id, array(
        'manageUser',
