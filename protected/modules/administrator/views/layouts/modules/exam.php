...
return array(
    ...
    'items' => array(
        ...
        array(
            'label' => $this->module->getMenuIcon('icon/master') . '11. ข้อมูลอาจารย์ผู้ตรวจข้อสอบ',
            'url' => array('codeExamApprover/index'),
            'active' => in_array($this->id, array(
                'codeExamApprover',
            )),
            'visible' => Yii::app()->user->checkPermission(array(
                'exam.codeExamApprover',
            )),
        ),
        array(
            'label' => $this->module->getMenuIcon('icon/master') . '12. ข้อมูลชุดสอบสำหรับทักษะการพูด',
            'url' => array('examSpeaking/index'),
            'active' => in_array($this->id, array(
                'examSpeaking',
            )),
            'visible' => Yii::app()->user->checkPermission(array(
