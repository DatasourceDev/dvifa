...
?>
<h4 class="text-center fancy">รายงาน :: <?php echo CHtml::value($core, 'search.room_testtype') === 'P' ? 'Practical Test' : 'Academic Test'; ?></h4>
...
$form = $this->beginWidget('booster.widgets.TbActiveForm', array(
    'type' => 'horizontal',
    'method' => 'get',
    'action' => array('viewApReport', 'id' => $model->id),
        ));
?>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        ?>
                        <?php
                        echo $form->textFieldGroup($core, 'search[room_level]', array(
                            'widgetOptions' => array(
                                'htmlOptions' => array(
                                    'placeholder' => '',
                                ),
                        ...
                        ?>
                        <?php
                        echo $form->textFieldGroup($core, 'search[donor_name]', array(
                            'widgetOptions' => array(
                                'htmlOptions' => array(
                                    'placeholder' => '',
                                ),
                        ...
                        ?>
                        <?php
                        echo $form->textFieldGroup($core, 'search[subject_name]', array(
                            'widgetOptions' => array(
                                'htmlOptions' => array(
                                    'placeholder' => '',
                                ),
                ...
                $this->widget('booster.widgets.TbButton', array(
                    ...
                    'icon' => 'refresh',
                    'buttonType' => 'link',
                    'url' => array('viewApReport', 'id' => $model->id),
                    'context' => 'success',
                ));
                ?>
            </div>
...
$this->widget('booster.widgets.TbListView', array(
    'itemView' => '_item',
    'template' => $this->renderPartial('reportTemplate', array(), true),
