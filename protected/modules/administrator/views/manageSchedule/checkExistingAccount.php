...
<div class="modal-body">
    ...
    <?php if (isset($application)): ?>
        <p class="text-danger">ไม่สามารถสมัครสอบได้ เนื่องจากพบว่ามีการสมัครในรอบสอบนี้แล้ว</p>
    <?php elseif ($examSchedule->hasErrors()): ?>
        <p class="text-danger"><?php echo Helper::errorSummary($examSchedule); ?></p>
    <?php else: ?>
...
<div class="modal-footer">
    ...
    $this->widget('booster.widgets.TbButton', array(
        ...
        'buttonType' => 'link',
        'url' => array('accountApply', 'id' => $model->id, 'exam_schedule_id' => $examSchedule->id),
        'context' => 'success',
        'icon' => 'pencil',
        'visible' => !isset($application) && !$examSchedule->hasErrors(),
    ));
    ?>
</div>