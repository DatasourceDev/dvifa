        ...
        echo $form->dropDownListGroup($profile, 'work_office_type', array(
            'widgetOptions' => array(
                ...
                'htmlOptions' => array(
                    ...
                    'data-target' => '#AccountProfileOfficeUser_work_office_id',
                ),
            ),
        ));
        ?>
...
<div class="row">
    <div class="col-sm-6">
        ...
        echo $form->dropDownListGroup($model, 'default_exam_schedule_id', array(
            'widgetOptions' => array(
                'data' => CHtml::listData(ExamSchedule::model()->inApplicableCondition()->sortBy('exam_code DESC')->findAll(), 'id', 'textExamCode'),
                'htmlOptions' => array(
                    'placeholder' => '',
...
<div class="btn-toolbar well">
    ...
    $this->widget('booster.widgets.TbButton', array(
        'label' => 'Cancel',
        'buttonType' => 'link',
        'url' => Yii::app()->request->getQuery('exam_schedule_id') ? array('manageSchedule/viewUser', 'id' => Yii::app()->request->getQuery('exam_schedule_id')) : array('index'),
        'context' => 'danger',
    ));
    ?>
    <?php
