<?php echo Helper::htmlTopic('รายงานรายได้'); ?>
<?php
...
<div class="text-center">
    ...
    <?php if ($model->income_type_id): ?>
        <div class="text-center">ประเภท <?php echo CHtml::value($model, 'incomeType.name'); ?></div>
    <?php endif; ?>
</div>
<div class="grid-view">
            ...
            <?php while ($current_date <= $model->date_end): ?>
                <?php if (isset($reportData[$current_date])): ?>
                    <tr>
                        ...
                        <?php foreach ($incomeTypes as $incomeType) : ?>
                            <td class="text-right"><?php echo CHtml::link(Yii::app()->format->formatMoney(CHtml::value($reportData, $current_date . '.' . $incomeType->id . '.amount')), array('view', 'Income' => array('income_date' => $current_date, 'income_type_id' => $incomeType->id)), array('class' => 'btn-ajax-modal')); ?></td>
                        <?php endforeach; ?>
                        <th class="text-right"><?php echo CHtml::link(Yii::app()->format->formatMoney(CHtml::value($reportData, $current_date . '.summary.amount')), array('view', 'Income' => array('income_date' => $current_date)), array('class' => 'btn-ajax-modal')); ?></th>
                    </tr>
                <?php endif; ?>
