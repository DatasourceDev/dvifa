        ...
        <table style="border-collapse: collapse;" width="100%">
            <thead>
                <tr>
                   ...
                   <th align="center" style="border:1px solid #000000;" colspan="2">ชื่อ-นามสกุล</th>
            ...
            <tbody>
                <?php foreach ($examSchedule->validExamApplications as $application): ?>
                    <tr>
                        ...
                        <td style="border:1px solid #000000;border-right: 0px;padding-left:10px;"><?php echo CHtml::value($application, 'title_th'); ?><?php echo CHtml::value($application, 'firstname_th'); ?></td>
                       <td style="border:1px solid #000000;border-left: 0px;">
                          <?php echo CHtml::value($application, 'lastname_th'); ?>
                       </td>
